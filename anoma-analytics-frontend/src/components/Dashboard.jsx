...
export function Dashboard() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const [overviewData, resourceData, transactionData, intentData, networkData] = await Promise.all([
  ...
  const statCards = [
    {
      ...
      value: overview?.total_resources?.toLocaleString() || '0',
      change: '+12.5%',
      trend: 'up',
      icon: Database,
      color: 'text-blue-600'
    ...
    },
    {
      ...
      value: overview?.total_intents?.toLocaleString() || '0',
      change: '-2.1%',
      trend: 'down',
      icon: Zap,
    ...
    {
      title: 'Current Block',
      value: overview?.current_block_height?.toLocaleString() || '0',
      change: '+0.8%',
      trend: 'up',
      icon: Blocks,
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Daily transaction count over the last week
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Current status of all intents in the system
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              TPS and processing time over the last 24 hours
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Summary of recent network activity
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="text-2xl font-bold text-blue-600">
                {overview?.recent_activity?.transactions_24h || 0}
              </div>
              <div className="text-sm text-gray-500">New Transactions</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-green-600">
                {overview?.recent_activity?.resources_24h || 0}
              </div>
              <div className="text-sm text-gray-500">Resources Created</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-yellow-600">
                {overview?.recent_activity?.intents_24h || 0}
              </div>
              <div className="text-sm text-gray-500">Intents Processed</div>
            </div>
          </div>
        </CardContent>
      </Card>
